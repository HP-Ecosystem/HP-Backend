...
class ResponseExampleSerializer(serializers.Serializer):
    """
    Serializer for successful response schema in OpenApi.

    Defines the structure of success responses for API documentation.
    """
